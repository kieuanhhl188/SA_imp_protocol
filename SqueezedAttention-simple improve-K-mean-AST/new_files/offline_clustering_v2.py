...
if __name__ == "__main__":
    ...
    for dataidx, d in enumerate(tqdm(data)):
        ...
        if args.hierarchical_lookup:
            ...
            torch.save(centroids_tensor_dict_l1, f'{args.output_path}/hierarchical_lookup_tensor_dict_L1_{dataidx}_{avg_l1}.pt')
            torch.save(centroids_labels_dict_l1, f'{args.output_path}/hierarchical_lookup_labels_dict_L1_{dataidx}_{avg_l1}.pt')
